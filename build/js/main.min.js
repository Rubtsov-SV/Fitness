...
var subscriptionButton = document.querySelectorAll('.subscription__term-button');
var offerList = document.querySelectorAll('.offer__list');
if (offerList) {
  subscriptionButton.forEach(function (button) {
  ...
  var changeList = function changeList(index) {
    subscriptionButton.forEach(function (button) {
      button.classList.remove('subscription__term-button--active');
    });
    offerList.forEach(function (list) {
  ...
  subscriptionButton.forEach(function (element, index) {
